...
export class RecipeEditComponent implements OnInit {
  ...
  onSubmit() {
    ...
    // NOTE:since the fields are same as in the recipeform, we can use the
    // below approach as well.
    if(this.editMode) {
    ...
    // navigate away since we are done.
    this.onCancel();
  }

  onAddIngredient() {
    // Add control to array of controls.
